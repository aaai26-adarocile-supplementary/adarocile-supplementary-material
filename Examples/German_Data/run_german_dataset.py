#!/usr/bin/env python3
"""
German Dataset Experiment Runner

This script runs experiments on the German dataset for 5 seeds using the BiasCorrected patch strategy.
...
def load_german_dataset():
    ...
    # Load dataset
    dataset_path = os.path.join('..', '..', 'datasets', 'german_cleaned.csv')
...
def run_german_experiment():
    """Run experiments on German dataset for 5 seeds."""
    print("German Dataset Experiment Runner")
    print("=" * 60)
    print(f"Starting experiments at {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    
    # Load dataset
    X, y, is_classification = load_german_dataset()
    ...
    for seed in range(seeds):
        ...
        try:
            ...
            initial_voting_metrics['Dataset'] = 'German_Data'
        ...
        try:
            ...
            rocile_metrics['Dataset'] = 'German_Data'
        ...
        try:
            ...
            adarocile_metrics['Dataset'] = 'German_Data'
    ...
    if all_results:
        ...
        results_file = 'German_Data_results.csv'
        results_df.to_csv(results_file, index=False, float_format='%.6f')
        
        # Save summary statistics
        summary_file = 'German_Data_summary.txt'
        with open(summary_file, 'w') as f:
            f.write("German Dataset - Experiment Summary\n")
            f.write("=" * 50 + "\n")
